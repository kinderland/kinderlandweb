	...
	function showCounter(currentPage, totalPage, firstRow, lastRow, totalRow, totalRowUnfiltered) {
        ...
        $(document).ready(function() {
			$('#sortable-table').datatable({
				...
				sort : [false,sortLowerCaseLink, false, false,false,false],
				filters : [false,true,false,false,false,false],
	...
	<div class="pad">
		<div class="main-container-report">
		            <div class = "row">
		                ...
		                <br>
		                Doações para o Evento: R$ <?php echo $value; ?>
		                <br/><br/>
		                <?php if(isset($info)){?>
					...
					style="max-width: 800px;" id="sortable-table">
							<tr>
								...
								<th style="width: 100px;">Sócio</th>
								<th style="width: 100px;">Valor</th>
								<th style="width: 150px;">Forma Pgto</th>
								<th style="width: 80px;">Parcelas</th>
							</tr>
							<?php foreach($info as $i){?>
								<tr>
									<td><?php echo $i->date_created;?></td>
									<td><a target="_blank" href="<?= $this->config->item('url_link') ?>user/details?id=<?= $i->person_id ?>"><?= $i->responsable_name ?></a></td>
									<td><?php if($i->associate == 't') echo "Sim"; else echo "Não";?></td>
									<td>R$ <?php echo $i->donated_value;?></td>
									<td><?php echo $i->payment_type;?></td>
									<td><?php echo $i->payment_portions;?></td>
								</tr>
							<?php }?>
						</table>
						</div>
