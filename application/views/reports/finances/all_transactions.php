<html lang="pt-br">
        ...
        <script>
			$( document ).ready(function() {
				$('#sortable-table').datatable({
    				...
    				sort: [
    				function (l, r) { return comparaPorData(l,r) },
    				function (l, r) { return l.toLowerCase().localeCompare(r.toLowerCase()); }, //Evita problemas com caps-lock
    				true, function (l, r) { return l.toLowerCase().localeCompare(r.toLowerCase()); }, //Evita problemas com caps-lock
    				true],
    				filters: [{
    ...
    values: {"01": "Janeiro", "02": "Fevereiro", "03": "Março", "04": "Abril", "05": "Maio", "06": "Junho", "07": "Julho", "08": "Agosto", 
                ...
                <div class="col-lg-12">
                	<form method="GET">
	                	<select name="ano" onchange="this.form.submit()" id="anos">
    	            		<option id="0" <?php if(!isset($ano)) echo "selected"; ?>)>Todos</option>
