    ...
    <body>
        ...
        <div class="scroll">
            <div class="main-container-report">
                <div class = "row">
                    <div class="col-lg-12">
                        <button class="button btn btn-primary" style="margin-left:95%" onclick="sendTableToCSV()" value="">Exportar</button>
                        <table class="table table-bordered table-striped table-min-td-size" style="width: 1000px; font-size:15px; margin-top:10px" id="sortable-table">
                            <thead>
                                <tr>
                                    <th> Nome </th>
                                    <th> E-mail </th>
