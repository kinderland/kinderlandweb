<html lang="pt-br">
    ...
    <body>
        ...
        function gerarTXTcomTelefones() {
            ...
            var name = getTXTName();
            var associates = document.getElementsByName('socio');
            var telephoneRes = [];
            var colonRes;
            var tels = [];
            var q = 0;
			...
			for (var i = 0, row; row = table.rows[i]; i++) {
				...
				var associate_id = associates[i].getAttribute('id');
            ...
            function getTXTName(type) {
            	var filtroYear = $("#anos option:selected").text();

    			nomePadrao = "socios_";

    			nomePadrao = nomePadrao.concat(filtroYear);
    			nomePadrao = nomePadrao.concat("_");	
    			return nomePadrao;   			
            }
                        ...
                        <table class="table table-bordered table-striped table-min-td-size" style="width: 600px; font-size:15px; margin-top:10px" id="sortable-table">
                            ...
                            <tbody id="tablebody">
                                ...
                                foreach ($info as $i) {
                                    ...
                                    ?>
                                    <tr>
                                        <td><a name="socio" id="<?= $i->id ?>" target="_blank" href="<?= $this->config->item('url_link') ?>user/details?id=<?= $i->id ?>"><?= $i->name ?></a></td>
                                        <td><?= $i->type ?></td>
                                    </tr>
                                    <?php
                                }
