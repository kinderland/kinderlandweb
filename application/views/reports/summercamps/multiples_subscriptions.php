        ...
        <div class="main-container-report">
            <div class = "row">
                <div class="col-lg-12">
                    ...
                    <table class="table table-bordered table-striped table-min-td-size" style="max-width: 900px; font-size:15px" id="sortable-table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                          <?php
                             ...
                             foreach ($colonists as $colonist) {
                               ?> 
                                <tr>
                                	<td><a id="<?= $colonist -> colonist_name ?>" target="_blank" href="<?= $this -> config -> item('url_link') ?>user/details?id=<?= $colonist -> colonist_id ?>"><?= $colonist->colonist_name ?></a></td>
