...
-->
						<td colspan="2"><?php if($countsAssociatedF->aguardando_validacao + $countsNotAssociatedF->aguardando_validacao !=0){?><a onclick="showSubReport('<?= $colonia_escolhida?>', '<?= $ano_escolhido?>', 1, null, 'F')" target="blank"
						...
						<td colspan="2"><?php if($countsAssociatedM->aguardando_validacao +$countsNotAssociatedM->aguardando_validacao !=0){?><a onclick="showSubReport('<?= $colonia_escolhida?>', '<?= $ano_escolhido?>', 1, null, 'M')" target="blank"
...
-->
						<th align="right" width='200px'>3. Pré-inscrições não validadas</th>
						<td colspan="2"><?php if($countsAssociatedF->nao_validada + $countsNotAssociatedF->nao_validada  !=0){?><a onclick="showSubReport('<?= $colonia_escolhida?>', '<?= $ano_escolhido?>', 6, null, 'F')" target="blank"
						...
						<td colspan="2"><?php if($countsAssociatedM->nao_validada + $countsNotAssociatedM->nao_validada !=0){?><a onclick="showSubReport('<?= $colonia_escolhida?>', '<?= $ano_escolhido?>', 6, null, 'M')" target="blank"
...
-->
						<th class="align-right">Subtotal(1+2+3)</th>
...
-->
						...
						<td colspan="2"><?php if($countsAssociatedF->validada + $countsNotAssociatedF->validada !=0){?><a onclick="showSubReport('<?= $colonia_escolhida?>', '<?= $ano_escolhido?>', 2, null, 'F')" target="blank"
						...
						<td colspan="2"><?php if($countsAssociatedM->validada + $countsNotAssociatedM->validada !=0){?><a onclick="showSubReport('<?= $colonia_escolhida?>', '<?= $ano_escolhido?>', 2, null, 'M')" target="blank"
...
-->
						<th align="right" width='200px'>6. Pré-inscrições na fila de espera</th>
						<td colspan="2"><?php if($countsAssociatedF->fila_espera + $countsNotAssociatedF->fila_espera !=0){?><a onclick="showSubReport('<?= $colonia_escolhida?>', '<?= $ano_escolhido?>', 3, null, 'F')" target="blank"
						...
						<td colspan="2"><?php if($countsAssociatedM->fila_espera + $countsNotAssociatedM->fila_espera !=0){?><a onclick="showSubReport('<?= $colonia_escolhida?>', '<?= $ano_escolhido?>', 3, null, 'M')" target="blank"
...
-->
						<th align="right" width='200px'>7. Pré-inscrições aguardando doação</th>
						<td colspan="2"><?php if($countsAssociatedF->aguardando_pagamento + $countsNotAssociatedF->aguardando_pagamento !=0){?><a onclick="showSubReport('<?= $colonia_escolhida?>', '<?= $ano_escolhido?>', 4, null, 'F')" target="blank"
						...
						<td colspan="2"><?php if($countsAssociatedM->aguardando_pagamento + $countsNotAssociatedM->aguardando_pagamento !=0){?><a onclick="showSubReport('<?= $colonia_escolhida?>', '<?= $ano_escolhido?>', 4, null, 'M')" target="blank"
...
-->
						<th align="right">8. Inscritos</th>
						<td colspan="2"><?php if($countsAssociatedF->inscrito + $countsNotAssociatedF->inscrito !=0){?><a onclick="showSubReport('<?= $colonia_escolhida?>', '<?= $ano_escolhido?>', 5, null, 'F')" target="blank"
						...
						<td colspan="2"><?php if($countsAssociatedM->inscrito + $countsNotAssociatedM->inscrito !=0){?><a onclick="showSubReport('<?= $colonia_escolhida?>', '<?= $ano_escolhido?>', 5, null, 'M')" target="blank"
