        ...
        <div class="main-container-report">
            <div class = "row">
                <div class="col-lg-12">
                    ...
                    <button class="button" onclick="sendTableToCSV()" value="">Fazer download da tabela abaixo como csv</button><button class="button" onclick="gerarPDFcomDadosCadastrais()" value="">PDF com dados cadastrais</button><br></br>
