        ...
        <div class="row">
            ...
            <select class="report-select" name="report_select" id="report_select">
                <?php if (in_array(SYSTEM_ADMIN, $permissions) || in_array(SECRETARY, $permissions) || in_array(DIRECTOR, $permissions) || in_array(COORDINATOR, $permissions) || in_array(DOCTOR, $permissions)) { ?>
                    <option selected="selected" value="<?= $this->config->item('url_link'); ?>reports/all_registrations">Estatísticas de Inscrições por Status</option>
                ...
                <?php } ?>
                <?php if (in_array(SYSTEM_ADMIN, $permissions) || in_array(SECRETARY, $permissions) || in_array(DIRECTOR, $permissions) || in_array(COORDINATOR, $permissions)) { ?>
