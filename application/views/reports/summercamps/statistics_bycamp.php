...
*/
			var url = "<?= $this->config->item('url_link'); ?>reports/subscriptions?type=2&camp="+camp+"&year="+2018+"&status="+status+"&associated="+associated+"&gender="+gender;
		else
			var url = "<?= $this->config->item('url_link'); ?>reports/subscriptions?type=2&camp="+camp+"&year="+2018+"&status="+status+"&gender="+gender;
