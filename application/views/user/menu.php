...
<div class="col-lg-10 middle-content">
        <div class="row">
            <div class="col-lg-8">
                <p align="right" style="border: 1px;font-size:14px;color:#428bca;"><button style="border: 3px solid #428bca;color:black;background-color:white;border-radius:5px;pointer-events:none">Valor arrecadado (atualizado às 13:00): R$ 468.330 (85,15%)</button></p>
            </div>
            <div class="col-lg-8">
