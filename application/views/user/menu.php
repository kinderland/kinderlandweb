...
<div class="col-lg-10 middle-content">
        <div class="row">
            <div class="col-lg-8">
                <p align="right" style="border: 1px;font-size:14px;color:#428bca;"><button style="border: 3px solid #428bca;color:black;background-color:white;border-radius:5px;pointer-events:none">Valor arrecadado (atualizado às 22:00): R$ 425.640 (77,38%)</button></p>
            </div>
            <div class="col-lg-8">
...
-->
        ...
        <form action="<?= $this->config->item('url_link') ?>donations/checkoutFreeDonation" method="POST">
            ...
            <div class="row">
                    <label for="fullname" class="col-lg-5 control-label"> Nome ou email (não obrigatório): </label> <input class="col-lg-6 type="text" size="20" class="form-control" value=""
