...
<div class="col-lg-10 middle-content">
        <div class="row">
            <div class="col-lg-8">
                <p align="right" style="border: 1px;font-size:16px;color:#428bca;"><button style="border: 3px solid #428bca;color:black;background-color:white;border-radius:5px;pointer-events:none">Valor arrecadado (atualizado às 20:00): R$ 180.123</button></p>
            </div>
            <div class="col-lg-8">
...
-->
        ...
        <div class="row">
            <div class="col-lg-8">
                <p align="right"><a href="http://www.kinderland.com.br/colonias-atuais/" target="_blank"><button align="right" class="btn btn-secondary" style="background-color:light-blue;font-size:14px;color:#428bca;border-radius:5px;border:3px solid #428bca">SOBRE A CAMPANHA</button></a></p>
            </div>
        </div>
