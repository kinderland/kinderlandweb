                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <p align="left">
                                    ...
                                    <b>R$ <?php echo $paymentPeriod->price; ?> a partir do dia <?= implode("/", explode("-", $date_start)); ?> até o dia <?= implode("/", explode("-", $date_finish)); ?>.</b>
                                ...
                                <?php } ?>
                            <?php } else if (strtotime($dataatual) > strtotime($date_finish)) {
                                ?>
                                <hr class="footer-hr"/>
                                <div class="row">
                                    <div class="col-lg-9">
