...
<html lang="pt-br">
    ...
    <div class="main-container">
        <div class="col-lg-12"><b><h3>Visualização de Documento</h3></b></div>
            ...
            <div class="col-lg-12 middle-content">
                ...
                <form enctype="multipart/form-data" name="document_form" method="POST" action="<?= $this->config->item('url_link') ?>admin/updateDocument/<?php echo $id; ?>" id="document_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <input  type="number" disabled="disabled" name="document_number" style="margin-left:-20px" value="<?php echo $number; ?>" class="form-control required"/>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <input type="text" disabled="disabled" name="document_name" class="form-control" style="margin-left:-20px" value="<?php echo $name; ?>"/>
                        </div>
                    </div>
                    <div class="row">
                        <label for="document_date" class="col-lg-3" style="padding-top:15px;width:15%"> Data <?php echo dataSwitch($type); ?> : </label>
                        <div class="col-lg-2">
                            <input type="text" disabled="disabled" class="datepickers required form-control" style="margin-left:-20px" name="document_date" value="<?php echo transform_date($date); ?>">
                        </div>
                    </div>
                    <div class="row">
                        <label for="description" class="col-lg-2" style="padding-top:15px;width:15%"> Descrição: </label>
                        <div class="col-lg-5">
                            <input type="text" disabled="disabled" name="description" maxlength="50" class="form-control" style="margin-left:-60px" value="<?php echo $description; ?>">   
                        </div>
                    </div>
                    <div class="row">
                        <label for="document_value" class="col-lg-2" style="padding-top:15px;width:15%"> Valor: </label>
                        <div class="col-lg-2">
                            <input class="form-control" disabled="disabled" type="number" size="6" name="document_value" style="margin-left:-100px" value="<?php echo $value; ?>"> 
                        </div>
                    </div>
                    </br>
                </form>
                ...
                <div style="margin-top:20px">
                    ...
                    <div class="col-lg-1">
                        <button style="padding-left:20px" class="btn btn-warning" onclick="window.history.back()"> Voltar</button>
                    </div>
                </div>
            </div>
            <hr />
