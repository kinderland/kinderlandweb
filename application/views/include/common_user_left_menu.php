<div class="col-lg-2  left-action-bar">
    <ul class="nav nav-pills nav-stacked">
        ...
        <li><a>Campanha de sócios<br />(inativo)</a></li>
        <li><a>Inscrições Eventos<br />(inativo)</a></li>
        ...
        <li><a href="<?= $this->config->item('url_link'); ?>user/emails">Histórico de <br>e-mails</a></li>
    </ul>
</div>