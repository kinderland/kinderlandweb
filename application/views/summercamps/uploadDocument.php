<div class = "row">
	...
	<form enctype="multipart/form-data" action="<?= $this -> config -> item('url_link'); ?>summercamps/saveDocument" method="POST">
		...
		<br>
		<span style="color:red">Atenção: documentos que tenham frente e verso, ambos são necessários. E documentos de identidade devem conter os nomes dos pais.</span>
		<br>
