...
class validation_model extends CK_Model {
	...
	public function updateColonistValidation($colonistId, $summerCampId, $genderOk, $pictureOk, $identityOk, $birthdayOk, $parentsNameOk, $colonistNameOk, $msgGender, $msgPicture, $msgIdentity, $msgBirthdate, $msgParentsName, $msgColonistName) {
		...
		if ($result) {
			...
			return $this -> execute($this -> db, $updateSql, array($genderOk, $pictureOk, $identityOk, $birthdayOk, $parentsNameOk, $colonistNameOk, $msgGender, $msgPicture, $msgIdentity, $msgBirthdate, $msgParentsName, $msgColonistName, intval($colonistId), intval($summerCampId)));
		} else {
			...
			return $this -> execute($this -> db, $insertSql, array(intval($colonistId), intval($summerCampId), $genderOk, $pictureOk, $identityOk, $birthdayOk, $parentsNameOk, $colonistNameOk, $msgGender, $msgPicture, $msgIdentity, $msgBirthdate, $msgParentsName, $msgColonistName));
		}
