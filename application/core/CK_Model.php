...
class CK_Model extends CI_Model {
    ...
    public function getConnection($dbIdentifier){
        //The parameter $dbIdentifier must indicate the name of the config database array index of the database to connect
        //acotelvas to connect to acotel_brazil_vas ; timesportes for tim_esporte
        //For more information check the database config file;
        try{
