...
class CK_Controller extends CI_Controller {
	...
	public function sendSubscriptionFinalMail($responsableId,$summerCampSubscription){
		...
		e a inscrição para a colônia " . $this -> summercamp_model -> getSummerCampById($summerCampSubscription->getSummerCampId()) -> camp_name . " está confirmada. <br><br>" . "Por favor, aguarde novas mensagens e comunicados, 
